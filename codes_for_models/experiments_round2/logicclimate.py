...
from logicedu import get_logger, MNLIDataset, train, eval1, pretty_print_scores, save_metrics_csv, predictions_already_saved, FALLACIES
import argparse
import pandas as pd
import torch
import os
...
if __name__ == "__main__":
    ...
    logger.info(args)
    make_dataset_and_model = args.finetune == "T" or not predictions_already_saved(args.save_predictions, args.save_labels)
    model = None
